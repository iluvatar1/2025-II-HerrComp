...
void initial_conditions(std::vector<Particle> & particles)
{
  ...
  particles[1].R[2] = -0.987;  // z is upwards, x to the right
  particles[1].V[0] = 3.9876;//12.987; // z is upwards, x to the right
  particles[1].V[2] = 2.1; //4.9876; //3.987; // z is upwards, x to the right
